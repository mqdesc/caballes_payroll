            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="lh-1">
                        ...
                        <dl class="d-flex w-100">
                            <dt class="col-auto">Late/Undertime<sup>mins</sup>:</dt>
                            <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                <?= isset($details['late_undertime']) ? (int)$details['late_undertime'] : 'N/A'; ?>
                            </dd>
                            <dt class="col-auto">Deduction:</dt>
                            <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                <?= isset($details['late_undertime_deduction']) ? '₱' . number_format($details['late_undertime_deduction'], 2) : 'N/A'; ?>
                            </dd>
                        </dl>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <dl class="d-flex w-100">
                                    ...
                                    <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                        <?= number_format($details['total_present'], 2) ?>
                                    </dd>
                                </dl>
                                <dl class="d-flex w-100">
                                    <dt class="col-auto">Overtime<sup>hours</sup>:</dt>
                                    <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                        <?= (int) $details['ot_hr'] ?>
                                    </dd>
                                    <dt class="col-auto">Total:</dt>
                                    <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                        <?= number_format($details['total_overtime'], 2) ?>
                                    </dd>
                                </dl>
                                <dl class="d-flex w-100">
                                    <dt class="col-auto">Legal<sup>hours</sup>:</dt>
                                    <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                        <?= (int) $details['leg_hr'] ?>
                                    </dd>
                                    <dt class="col-auto">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total:</dt>
                                    <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                        <?= number_format($details['total_legal'], 2) ?>
                                    </dd>
                                </dl>
                                <dl class="d-flex w-100">
                                    <dt class="col-auto">Special<sup>hours</sup>:</dt>
                                    <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                        <?= (int) $details['sp_hr'] ?>
                                    </dd>
                                    <dt class="col-auto">&nbsp;&nbsp;&nbsp;Total:</dt>
                                    <dd class="col-auto flex-shrink-1 flex-grow-1 px-2">
                                        <?= number_format($details['total_special'], 2) ?>
                                    </dd>
                                </dl>
                            </div>
                        </div>
