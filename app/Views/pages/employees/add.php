                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-0" id="code" name="code" autofocus placeholder="Company ID" value="<?= !empty($request->getPost('code')) ? $request->getPost('code') : $increemented_code ?>" required="required">
                        </div>
                        <div class="mb-3">
